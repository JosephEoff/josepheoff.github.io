...
Thread the machine according to the [manual](/assets/2022-02-02-adler9/jones_spool_short.pdf) (or use [my guide to threading the Adler class8,](adler12)) then use the upper thread to pull the lower thread up through the needle plate.
