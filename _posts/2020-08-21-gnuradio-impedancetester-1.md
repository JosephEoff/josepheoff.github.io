...
To measure impedance at one frequency, you apply a signal with the desired frequency to \$LineOut_{Left}\$, measure at \$LineIn_{Left}\$ and \$LineIn_{Right}\$, do a little math and you're done.
