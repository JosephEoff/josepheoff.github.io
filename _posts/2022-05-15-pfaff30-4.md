...
*There are two slotted plates on the cabinet, one on the right below the balance wheel and one on the left at the edge of the lid.  These two plates form a lath to lock the lid down (closed.)*
